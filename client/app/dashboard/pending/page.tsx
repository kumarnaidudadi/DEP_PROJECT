'use client';
// ─── /dashboard/pending ────────────────────────────────────────────────────────
// Pending Work: List view with Needs Review / Previously Processed tabs
...
function PendingWorkContent() {
    ...
    const handleSelectApplication = (app: Application) => {
        router.push(`/dashboard/pending/${app.id}?tab=${appTab}`);
    };
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    ...
                                    color: active ? (isPending ? '#2563eb' : '#059669') : '#6b7280',
                                    borderBottom: active
                                        ? `2.5px solid ${isPending ? '#2563eb' : '#059669'}`
            ...
            <main style={{ flex: 1, overflowY: 'auto', padding: '24px 32px' }}>
                {loading ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '260px', color: '#94a3b8' }}>
                        ...
                        <p style={{ fontSize: '13px', margin: 0 }}>There are no {appTab === 'ongoing' ? 'pending' : 'processed'} applications matching your criteria.</p>
                    </div>
                ) : (
                    <div style={{
